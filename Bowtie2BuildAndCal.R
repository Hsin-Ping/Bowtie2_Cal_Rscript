library(getopt)
args=matrix(
 c( "input", "i", 2, "character", "Folder name of all transcriptomes(default_path:~/Desktop).",
    "output", "o", 2, "character", "Create folder for saving bowtie2 results(default_path:~/Desktop).",
